...
itemList = {"get": "list"}
itemDetail = {"get": "retrieve", "post": "create",
...
urlpatterns = [
    ...
    # Detailed routes
    path('units/<int:pk>/', views.UnitsViewSet.as_view(itemDetail),
         name="units-detail"),
    path('locals/<int:pk>/', views.LocalsViewSet.as_view(itemDetail),
         name="locals-detail"),
    path('sensors/<int:pk>/', views.SensorsViewSet.as_view(itemDetail),
         name="sensors-detail"),
    path('alerts/<int:pk>/', views.AlertsViewSet.as_view(itemDetail),
         name="alerts-detail"),
    path('colectors/<int:pk>/', views.ColectorsViewSet.as_view(itemDetail),
         name="colectors-detail"),
    # Sensors measurements
    path('sensors/<int:idsensor>/measurements/',
